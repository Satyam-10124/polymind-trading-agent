...
def apply_slippage(price: float, side: str, size_usdc: float = 0.0,
    ...
    """
    Returns the realistic fill price for `side` ('YES'/'BUY' vs 'NO'/'SELL').
    A buy fills higher than `price`; a sell fills lower. Size adds a small extra
    impact term (10% more slippage per $1k of notional, capped at 3x base).
    """
